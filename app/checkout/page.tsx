            ...
            <dl className="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-900 lg:block">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                ...
                <dd className="text-base">
                  {formatPrice(total === 0 ? 0 : total + total / 5 + 5)}
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                disabled={isSubmitting}
                className="w-full rounded-md border border-transparent bg-blue-500 px-20 py-2 text-lg font-medium text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
